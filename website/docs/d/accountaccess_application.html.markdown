...
Looks up an existing AWS Account Access [Application](../../resources/accountaccess_application). Lookup is by Application ARN or by IAM Identity Center instance ARN (one Application per instance).
...
* `id` - Application ARN. Same as `arn`.
